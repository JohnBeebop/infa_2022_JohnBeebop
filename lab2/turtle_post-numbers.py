print("Привет, Марусик! Ты готова увидеть великую и ужасную, ВСЕМОГУЩУЮ Черепаху??? X-D")
otvet = input()
if otvet == "да" or otvet == "yes":
    ...
    pochtovyiindex = [one, nine, six, six, two, zero] #6 цифр, которые мы, собственно рисуем черпахой

    for i in pochtovyiindex:
        for y in i:
            turtle.right(y[0])
            turtle.forward(y[1])
        turtle.penup()
